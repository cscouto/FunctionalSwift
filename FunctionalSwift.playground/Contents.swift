...
/////------------------------Loops-------------------------------------
////enumarated
//    //gives you the index of a sequence
//let enumeratedValues = [1,2,3,4,5,6,7]
//for (index, value) in enumeratedValues.enumerated() {
//    //print(index)
//}
//
////labeled loops
//
//forLoop: for (index, value) in enumeratedValues.enumerated() {
//    //print(index)
//    if index == 0 {
//        break forLoop
//    }
